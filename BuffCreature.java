...
//5-space jumping creatures

public class BuffCreature extends Movement
{//uses the template of Movement abstract class to function
	public BuffCreature(Map map, int r, int c) {
		super(map, r, c);
		//adjust the size of the step from the template Movement class
		super.setOneStep(5);
	}
